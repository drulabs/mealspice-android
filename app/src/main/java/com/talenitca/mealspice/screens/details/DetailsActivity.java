...
public class DetailsActivity extends AppCompatActivity implements DetailsContract.View {
    ...
    public static final String KEY_RESTAURANT_SLUG = "restaurant_slug";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras==null || !extras.containsKey(KEY_RESTAURANT_SLUG)){
            finish();
            return;
        }

        presenter = new DetailsPresenter(this);
        presenter.start(extras.getString(KEY_RESTAURANT_SLUG));
    }
